    ...
    <div className="pt-10 pb-28 w-full max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto px-4 sm:px-5 md:px-8 lg:px-12 xl:px-0 min-h-screen flex flex-col">
      ...
      <div className="mt-6 grid grid-cols-2 gap-3">
        {harmonizedItems.map((i) => (
          <div
            key={i.product?.id}
            className="relative rounded-xl border border-zinc-200 p-2 flex flex-col items-center gap-2 min-w-0"
          >
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-[13px] font-poppins w-6 text-center">
                {i.qty}
              </span>
              <button
