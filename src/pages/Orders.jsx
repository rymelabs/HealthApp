...
// Reusable Support Links Component
const SupportLinks = ({ small = false }) => (
  <div className={`flex flex-col gap-2 ${small ? "mt-3 sm:mt-4" : "mt-4"}`}>
    <a
      href="https://wa.me/2348000000000"
      target="_blank"
      rel="noopener noreferrer"
      className={`flex items-center gap-2 ${small ? "text-xs sm:text-sm" : "text-sm"} font-medium text-green-600 hover:underline`}
    >
    ...
    <a
      ...
      className={`flex items-center gap-2 ${small ? "text-xs sm:text-sm" : "text-sm"} font-medium text-sky-600 hover:underline`}
    >
