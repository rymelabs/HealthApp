...
return (
  <AuthLayout>
    ...
    <div className="mt-6 text-left text-zinc-500 text-[13px] sm:text-[14px] md:text-[16px] font-light">Already have an account? <Link to="/auth/customer/signin" className="text-sky-600 font-medium">Sign In</Link></div>
  </AuthLayout>
);
}