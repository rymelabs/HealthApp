...
return (
  <AuthLayout>
    ...
    <p className="mt-4 text-zinc-500 text-[13px] sm:text-[14px] md:text-[16px] tracking-tight font-thin leading-[154%] font-poppins text-left">Pick up and deliver medical prescribed medications and, over-the-counter items from pharmacies to your doorstep.</p>
    <div className="mt-8 flex flex-row gap-4 w-full max-w-[350px] mx-0">
      <button onClick={()=>setRole('customer')} className={`relative rounded-3xl p-0 text-left border-[1] font-poppins bg-[#F7F7F7] w-[169px] h-[169px] border-[1px] ${role==='customer'?'border-[#36A5FF] border-[1.5px] ring-2 ring-[#36A5FF]':'border-[#36A5FF]'}`}>
        ...
        <div className="absolute left-[9px] top-[127px] text-zinc-400 text-[12px] sm:text-[13px] font-extralight tracking-tight leading-[109%] font-poppins">Sign Up or Login as a customer</div>
      </button>
      <button onClick={()=>setRole('pharmacy')} className={`relative rounded-3xl p-0 text-left border-[2] font-poppins bg-[#F7F7F7] w-[169px] h-[169px] border-[1px] ${role==='pharmacy'?'border-[#36A5FF] border-[1.5px] ring-2 ring-[#36A5FF]':'border-[#36A5FF]'}`}>
        ...
        <div className="absolute left-[9px] top-[127px] text-zinc-400 text-[12px] sm:text-[13px] font-extralight tracking-tight leading-[109%] font-poppins">Sign Up or Login as a pharmacy</div>
      </button>
    </div>
