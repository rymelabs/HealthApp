...
function CustomerIllustration({ className, stroke }) {
  return (
    <svg
      viewBox="0 0 91 152"
      fill="none"
...
function PharmacyIllustration({ className, stroke }) {
  return (
    <svg
      viewBox="0 0 124 154"
      fill="none"
...
export default function Landing() {
  ...
  const navigateToRole = () => {
    navigate(role === 'customer' ? '/auth/customer/signin' : '/auth/pharmacy/signin');
  };
