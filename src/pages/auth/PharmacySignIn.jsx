...
<div className="mt-2 text-left text-zinc-500 text-[13px] sm:text-[14px] md:text-[16px] font-light">Don’t have an account? <Link to="/auth/pharmacy/register" className="text-sky-600 font-medium">Register</Link></div>
</AuthLayout>
);
}