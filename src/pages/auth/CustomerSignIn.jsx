...
<div className="mt-2 text-center text-zinc-500 text-[14px] md:text-[16px] font-light">Don’t have an account? <Link to="/auth/customer/register" className="text-sky-600 font-medium">Register</Link></div>
</AuthLayout>
);
}