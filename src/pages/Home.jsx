...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="max-w-md mx-auto px-5">
          <div className="flex justify-between items-center w-full h-[54px]">
            <div className="flex flex-col justify-center">
              <div className="text-[20px] font-thin font-poppins">Hello{user?`, ${user.displayName?.split(' ')[0]||'Friend'}`:''}</div>
              <span className="text-zinc-500 text-[12px] font-thin font-poppins">Kuje, FCT, Abuja</span>
            </div>
            <div className="flex flex-col justify-center items-end">
              <div className="flex items-center gap-1">
                <ClockIcon className="h-4 w-4"/>
                <span className="text-[12px] font-poppins font-thin text-right leading-tight">35 Mins to Hmedix Pharmacy</span>
              </div>
            </div>
          </div>
      ...
      <div className="pt-1 pb-28 max-w-md mx-auto px-5">
        <div className="mt-6 flex items-center gap-3 border-b border-zinc-300 pb-2">
          <SearchIcon className="h-5 w-5 text-zinc-400"/>
          <input value={q} onChange={(e)=>setQ(e.target.value)} placeholder="Search drugs, pharmacies" className="w-full outline-none placeholder:text-[12px] placeholder:text-[#888888] placeholder:font-light"/>
        ...
        <div className="mt-3 mb-2 w-full overflow-x-auto scrollbar-hide">
          <div className="flex gap-3 min-w-max">
            {['All', 'Prescription', 'Over-the-counter', 'Syrup', 'Therapeutic', 'Controlled', 'Target System'].map(cat => (
              <button
                key={cat}
                className="px-4 py-2 rounded-full bg-zinc-100 text-zinc-700 text-[9px] font-poppins font-light whitespace-nowrap border border-zinc-200 hover:bg-sky-50 transition"
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-3">
            <div className="text-[15px] font-medium font-poppins">New Arrivals</div>
            <button className="text-[13px] font-normal font-poppins text-sky-600">view all</button>
          </div>
        ...
        <div className="mt-10">
          <div className="text-[15px] font-medium font-poppins mb-3">Popular Products</div>
