  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`absolute bottom-0 right-0 z-10 h-8 w-8 flex items-center justify-center border-l border-t bg-inherit border-solid btn-interactive transition-all duration-200 hover:scale-110 hover:shadow-lg ${
